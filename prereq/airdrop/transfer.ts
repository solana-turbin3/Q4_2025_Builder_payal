...
const from = await createKeyPairSignerFromBytes(new Uint8Array(wallet));
const to = address("EEE2dZ4EHFHmgG24zKgVUutCXQqtYTLJCEAWoNcNAXTj");
...
//   (tx) => setTransactionMessageFeePayerSigner(from, tx),
